var offset = (window.screen.availHeight / 100) * 20,
  ...
  l4 = document.getElementById("c4").offsetTop - offset,
  height,
  height2,
  col = 0,
  dots = [document.getElementById("d1"), document.getElementById("d2"), document.getElementById("d3"), document.getElementById("d4"), document.getElementById("d5"),],
  hed = [document.getElementById("w0"), document.getElementById("w1"), document.getElementById("w2"), document.getElementById("w3"), document.getElementById("w4")];
...
function myFunction() {
    ...
    if ((height >= l3 && height < l4) || (height2 >= l3 && height2 < l4)) {
      col = 3;
    }
    if (height >= l4  ||height2 >= l4 ) {
      col = 4;
    }
